                                    ...
                                    <div class="main-menu">
                                        <nav>
                                            <ul id="navigation">
                                                ...
                                                <li><a href="/aboutnotlogin">About</a></li>
                                                <li><a href="#">Poly <i class="ti-angle-down"></i></a>
                                                    <ul class="submenu">
                                                ...
                                                <li><a href="/contactnotlogin">Contact</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                    <div class="btn-group">
                    ...
                    <div class="col-xl-4  col-md-6 col-lg-4">
                        <div class="footer_widget">
                            ...
                            <ul class="meting_time">
                                <li class="d-flex justify-content-between "><span>Senin - Jumat</span> <span>8.00 - 18.00</span></li>
                                <li class="d-flex justify-content-between "><span>Sabtu	</span> <span>8.00 - 15.00</span></li>
